const PRODUCTS = [
  ...
  {
    id: 'soteria-pulse-discovery',
    category: 'Soteria Pulse Inquiry',
    name: 'Soteria Pulse Discovery Call',
    description: 'Request a Soteria Pulse discovery call. No payment required.',
    amount: 0,
    currency: 'cad',
    tax_behavior: 'non_taxable',
    inventory_status: 'inquiry_only',
    image: '',
    mode: 'inquiry_only',
    enabled: true
  }
