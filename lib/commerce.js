...
async function quoteRequest(req, res) {
  ...
  await syncToPulse(normalized);
  return json(res, 200, { ok: true, quote: normalized, emailNotification: 'placeholder' });
}
...
async function stripeWebhook(req, res) {
  ...
  // TODO: Connect persistent order storage here. Current static launch build acknowledges events
  // and prepares normalized records for Soteria Pulse, but does not yet persist webhook state.
